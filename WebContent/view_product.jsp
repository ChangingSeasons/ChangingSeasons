				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							...
							&nbsp <input type="checkbox" name="color" value="White">
							White &nbsp <input type="checkbox" name="color" value="Red">
							Red &nbsp <input type="checkbox" name="color" value="Brown">
							Brown &nbsp <input type="checkbox" name="color" value="Grey">
							Grey &nbsp <input type="checkbox" name="color" value="Blue">
							Blue &nbsp
						</div>
					</div>
					...
					<p>
						<strong>Quantity: </strong> <select id="quanity"
							style="width: auto;" class="form-control selectWidth">
